...
{
    /// <inheritdoc />
    public partial class RolCalendario : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            InsertarRol(migrationBuilder, "Calendario");
        }
        ...
        {
            migrationBuilder.Sql("DELETE FROM \"AspNetRoles\" WHERE \"Name\" IN ('Calendario')");
        }
    }
}
