...
namespace CentroSenderos_2026_BD.Migrations
{
    ...
    [Migration("20260919001952_AsociarPrestacionConProfesionalEnTurno")]
    partial class AsociarPrestacionConProfesionalEnTurno
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CentroSenderos_2026_BD.Datos.Entity.SerieTurno", b =>
                {
                    ...
                    b.Property<int?>("UnidadPersonalizada")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("CentroSenderos_2026_BD.Datos.Entity.ProfesionalTipoPrestacion", b =>
                {
                    b.HasOne("CentroSenderos_2026_BD.Datos.Entity.Profesional", "Profesional")
                        .WithMany("ProfesionalTipoPrestaciones")
                        .HasForeignKey("ProfesionalId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("CentroSenderos_2026_BD.Datos.Entity.TipoPrestacion", "TipoPrestacion")
                        .WithMany("ProfesionalTipoPrestaciones")
            ...
            modelBuilder.Entity("CentroSenderos_2026_BD.Datos.Entity.Turno", b =>
                {
                    b.HasOne("CentroSenderos_2026_BD.Datos.Entity.SerieTurno", "SerieTurno")
                        .WithMany("Turnos")
                        .HasForeignKey("SerieTurnoId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("CentroSenderos_2026_BD.Datos.Entity.TurnoPaciente", b =>
                {
                    ...
                    b.HasOne("CentroSenderos_2026_BD.Datos.Entity.TipoObraSocial", "TipoObraSocial")
                        .WithMany()
                        .HasForeignKey("TipoObraSocialId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("CentroSenderos_2026_BD.Datos.Entity.Profesional", b =>
                {
                    ...
                    b.Navigation("ProfesionalTipoPrestaciones");
