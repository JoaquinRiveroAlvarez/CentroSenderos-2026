...
{
    /// <inheritdoc />
    public partial class precargados : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "OSDE", "Organización de Servicios Directos Especializados", "Cobertura privada", 0 },
                    { "IOMA", "Instituto de Obra Médico Asistencial", "Obra social provincial", 0 },
                    { "SURA", "SURA Seguros de Salud", "Aseguradora de salud", 0 },
                    { "Swiss Medical", "Swiss Medical Group", "Seguros de salud privado", 0 },
                    { "Medifé", "Medifé Entidad de Medicina Prepaga", "Medicina prepaga", 0 },
                    { "Galeno", "Galeno Seguros de Salud", "Medicina prepaga", 0 },
                    { "BMI", "Bupa Médica Internacional", "Cobertura de salud privada", 0 },
                    { "Accord Salud", "Accord Salud", "Medicina prepaga", 0 },
                    { "Particular", "Paciente particular sin obra social", "Pago directo", 0 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "Lic. Juan Carlos López", "Psicomotricista", "20-12345678-91", "0017", "100019", "+54 11 2345-6789", "Especialista en psicomotricidad infantil", 0 },
                    { "Lic. María González Ruiz", "Psicóloga", "27-87654321-01", "0027", "100029", "+54 11 3456-7890", "Psicopedagoga clínica, coordina talleres", 0 },
                    { "Lic. Roberto Martínez Silva", "Psicopedagogo", "23-45678901-21", "0037", "100039", "+54 11 4567-8901", "Especialista en evaluación educativa", 0 },
                    { "Lic. Patricia Fernández López", "Psicopedagoga de Integración", "24-56789012-31", "0047", "100049", "+54 11 5678-9012", "Especialista en integración escolar", 0 },
                    { "Lic. Carlos Alberto Romero", "Fonoaudiólogo", "20-67890123-41", "0057", "100059", "+54 11 6789-0123", "Especialista en trastornos del lenguaje", 0 },
                    { "Lic. Ana María Torres García", "Kinesióloga", "25-78901234-51", "0067", "100069", "+54 11 7890-1234", "Especialista en neurorehabilitación", 0 },
                    { "Lic. Fernando Díaz Pérez", "Psicomotricista", "21-89012345-61", "0077", "100079", "+54 11 8901-2345", "Especialista en motricidad fina y gruesa", 0 },
                    { "Lic. Gabriela López Martínez", "Psicóloga", "22-90123456-71", "0087", "100089", "+54 11 9012-3456", "Psicopedagoga, facilita talleres grupales", 0 },
                    { "Lic. Miguel Ángel Suárez", "Fonoaudiólogo", "26-01234567-81", "0097", "100099", "+54 11 0123-4567", "Especialista en comunicación y deglución", 0 },
                    { "Lic. Verónica Castro Rodríguez", "Kinesióloga", "23-12345678-91", "0107", "100109", "+54 11 1234-5678", "Especialista en rehabilitación motora", 0 }
                });
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DeleteData(
                table: "Profesionales",
                keyColumn: "Cuit",
                keyValue: "20-12345678-91");

            migrationBuilder.DeleteData(
                table: "Profesionales",
                keyColumn: "Cuit",
                keyValue: "27-87654321-01");

            migrationBuilder.DeleteData(
                table: "Profesionales",
                keyColumn: "Cuit",
                keyValue: "23-45678901-21");

            migrationBuilder.DeleteData(
                table: "Profesionales",
                keyColumn: "Cuit",
                keyValue: "24-56789012-31");

            migrationBuilder.DeleteData(
                table: "Profesionales",
                keyColumn: "Cuit",
                keyValue: "20-67890123-41");

            migrationBuilder.DeleteData(
                table: "Profesionales",
                keyColumn: "Cuit",
                keyValue: "25-78901234-51");

            migrationBuilder.DeleteData(
                table: "Profesionales",
                keyColumn: "Cuit",
                keyValue: "21-89012345-61");

            migrationBuilder.DeleteData(
                table: "Profesionales",
                keyColumn: "Cuit",
                keyValue: "22-90123456-71");

            migrationBuilder.DeleteData(
                table: "Profesionales",
                keyColumn: "Cuit",
                keyValue: "26-01234567-81");

            migrationBuilder.DeleteData(
                table: "Profesionales",
                keyColumn: "Cuit",
                keyValue: "23-12345678-91");
