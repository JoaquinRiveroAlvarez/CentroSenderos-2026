    ...
    public class TurnoRepositorio : Repositorio<Turno>, ITurnoRepositorio
    {
        ...
        public async Task<TurnoDTO?> SelectPorId(int id)
        {
            return await context.Turnos
                ...
                {
                    Id = t.Id,
                    // Separamos fecha y hora al devolver
                    Fecha = DateOnly.FromDateTime(t.FechaInicio),
                    Hora = TimeOnly.FromDateTime(t.FechaInicio),
                    FechaFin = t.FechaFin,
        ...
        public async Task<int> InsertarTurno(TurnoDTO dto)
        {
            ...
            DateTime fechaInicioUtc = DateTime.SpecifyKind(dto.Fecha.ToDateTime(dto.Hora), DateTimeKind.Utc);
